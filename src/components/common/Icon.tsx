...
export const ICON_NAMES = ['inactive', 'active', 'add', 'arrowLeft', 'bottle', 'chocolate', 'close', 'deleteIcon', 'directions', 'hands', 'house', 'meal', 'people', 'remove', 'chevronRight', 'facebook', 'linkedin', 'twitter'] as const
export type IconName = typeof ICON_NAMES[number];

const IconImages: { [k in IconName]: FC<{ fill: TailwindColor, className: string }> } = Icons as any

interface IconProps extends Partial<TailwindProps<'p' | 'w' | 'bg' | 'rounded' | 'm' | 'mx' | 'mr' | 'borderColor' | 'borderWidth'>> {
  icon: IconName,
  fill?: TailwindColor,
  onClick?: () => void,
}
